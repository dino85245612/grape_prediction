...
public interface IUVCServiceOnFrameAvailable extends android.os.IInterface
{
    ...
    public static abstract class Stub extends android.os.Binder implements org.tensorflow.lite.examples.detection.tracking.IUVCServiceOnFrameAvailable
    {
         ...
         */
        public static org.tensorflow.lite.examples.detection.tracking.IUVCServiceOnFrameAvailable asInterface(android.os.IBinder obj)
        {
            if ((obj==null)) {
                return null;
            }
            android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (((iin!=null)&&(iin instanceof org.tensorflow.lite.examples.detection.tracking.IUVCServiceOnFrameAvailable))) {
                return ((org.tensorflow.lite.examples.detection.tracking.IUVCServiceOnFrameAvailable)iin);
            }
            return (IUVCServiceOnFrameAvailable) new Proxy(obj);
        }
        ...
        private static class Proxy implements org.tensorflow.lite.examples.detection.tracking.IUVCServiceOnFrameAvailable
        {
